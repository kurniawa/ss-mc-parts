...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_spk = $_POST["id_spk"];
    $busa_stang = $_POST["busa_stang"];
    $harga_busa_stang = $_POST["harga_busa_stang"];

    $harga_price_list += (int)$harga_busa_stang;

    $nama_lengkap .= "$busa_stang";
    ...
    $htmlLogOK = $htmlLogOK .
        "busa_stang: " . $busa_stang . "<br>" .
        "harga_busa_stang: " . $harga_busa_stang . "<br>" .
        "jahit: " . $tipe_jahit . "<br>" .
